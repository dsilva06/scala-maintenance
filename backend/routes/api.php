...
// AI agent endpoints are disabled for this release; keep imports for later integration.
...
$registerAppRoutes = function () {
    // AI agent endpoints disabled for this release.
    ...
    Route::apiResource('repair-guides', RepairGuideController::class);
